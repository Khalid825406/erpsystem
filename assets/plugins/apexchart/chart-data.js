...
if($('#patient-statistics').length > 0 ){
  var sCol = {
      chart: {
          height: 375,
          type: 'bar',
    ...
    series: [{
        name: 'New Patients',
        data: [130, 260, 300, 230, 375, 320, 260, 180, 220, 220]
    }, {
        name: 'Old Patients',
        data: [220, 170, 330, 200, 160, 280, 260, 220, 260, 190]
    }],
    xaxis: {
  ...
  var chart = new ApexCharts(
      document.querySelector("#patient-statistics"),
      sCol
  );
...
if($('#transaction-chart').length > 0 ){
  var sCol = {
      ...
      series: [{
          name: "Completed",
          data: [60, 40, 25, 20, 60, 15, 55, 120, 30, 20, 50, 60]
      }, {
          name: "Pending",
          data: [35, 20, 20, 10, 50, 5, 10, 20, 20, 10, 30, 40]
      }],
      xaxis: {
