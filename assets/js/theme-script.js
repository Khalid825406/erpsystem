...
<div class="sidebar-contact ">
    ...
    <div class="offcanvas-header d-flex align-items-center justify-content-between bg-light-500">
        ...
        <a href="javascript:void(0);" class="custom-btn-close d-flex align-items-center justify-content-center text-white"  data-bs-dismiss="offcanvas"><i class="ti ti-x"></i></a>
    </div>
                       ...
                       <div class="d-flex align-items-center">
                            ...
                            <div class="theme-sidebarbg me-3">
                                ...
                                <label for="sidebarBg2" class="d-block rounded">
                                     <img src="assets/img/theme/sidebar-bg-07.png" alt="img" class="rounded">
                                </label>
                            </div>
                            <div class="theme-sidebarbg me-3">
    ...
    <div class="bg-light-500 p-3">
        <div class="row gx-3">
            <div class="col-6">
                <a href="javascript:void(0);" id="resetbutton" class="btn btn-light close-theme w-100">Reset</a>
            </div>
            <div class="col-6">
                <a href="javascript:void(0);" class="btn btn-primary w-100" data-bs-dismiss="offcanvas">Buy</a>
            </div>
        </div>
    </div>
    </div> `
    ...
    document.querySelector("body").insertAdjacentHTML("beforeend", themesettings);
